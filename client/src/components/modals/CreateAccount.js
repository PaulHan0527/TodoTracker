...
const CreateAccount = (props) => {
	...
	return (
		...
		<WModal className="signup-modal" visible={true} cover={true} animation="slide-fade-top">
			...
			{/* <WButton className="modal-button close-button" onClick={() => props.setShowCreate(false)} span clickAnimation="ripple-light" hoverAnimation="darken" shape="rounded" wType="texted">
				Cancel
			</WButton> */}
		</WModal>
